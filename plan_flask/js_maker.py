...
from plan_flask.module.mvc_plan import Plan, module_info

mvc_plan_dir = '/home/ubuntu/git/npm_pro/pages/plan'
...
js_module = [
    # import 
    r"import {Canvas2} from '../../demo/canvas_demo/f_map5'",
    # r"import {Canvas2} from '../../demo/canvas_demo/f_map4'",
    # r"import {Canvas2} from '../../demo/canvas_demo/f_map3'",
    r"import { useCallback, useState, useEffect } from 'react'",
    # class switch_case code
    # for list parse
