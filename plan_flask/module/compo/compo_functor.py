...
class Com_functor(Com_html):
    ...
    class Com_Functor(Com_common):
        ...
        # def init(self, x, y, name, spec_id, 
        #     offset_xy=(0,0), 
        ...
        def init(self, spec_id, name, offset, level, 
            ...
            **kwargs):
            ...
            # self.offset_x = offset_xy[0]
            # self.offset_y = offset_xy[1]

            self.functor_type = self.__class__.__name__
        ...
        def f_id(self):
            for i,functor in enumerate(self.root.canvas.graph_functor_list):
