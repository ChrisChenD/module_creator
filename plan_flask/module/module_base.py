...
class Module_base(Traversed_module):
    ...
    def js_code(self):
        ...
        member_set = ('\n'+' '*8).join([ 
            ...
            for member in self.m_ext()+['common_act']])

        member_set_call = ('\n'+' '*8).join([ 
            f"self.{member}.common_act = self.common_act"
...
class Module_root(Module_base):
    ...
    @property
    def f_name(self):
        return f'plan_flask/module/plan_history/{self.name}.module'
