...
from plan_flask.module.mvc_functor_table import ReadMysqlDb_Table, Table2
from plan_flask.module.mvc_functor_table import cls_select
...
class ColAppend(Functor_base):
    ...
    def out_fields(self, prev_fields):
        ...
        out_fields = prev_fields+[
            field for field in 
            self.table.out_fields()
            if field not in prev_fields
        ]
        
        return [*prev_fields, *out_fields, 
            root_key, key_type, 
        ]
